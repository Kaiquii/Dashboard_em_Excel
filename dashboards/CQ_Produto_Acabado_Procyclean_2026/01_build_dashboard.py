...
INPUT = PROJECT_ROOT / "inputs" / DASHBOARD_ID / "CQ Produto Acabado - Procyclean 2026.xlsm"
WORK_DIR = PROJECT_ROOT / ".tmp" / DASHBOARD_ID
OUTPUT = WORK_DIR / "CQ Produto Acabado - Procyclean 2026 - Dashboard-openpyxl.xlsm"
...
def product_name(sheet_name):
    return re.sub(r"^procyclean\s+", "", sheet_name, flags=re.I).strip() or sheet_name
